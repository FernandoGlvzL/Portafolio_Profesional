# Portafolio Profesional - Ciberseguridad //  Fernando Galvez L

## Declaracion Profesional
Soy un Estudiante de Ingenieria Informatica, cuento con un buen conocimiento teorico y una buena base tecnica en ciberseguridad, 
apasionado por la proteccion de datos y infraestructura critica. Mi enfoque se centra en el aprendizaje y practica continua para
...
### Puntos Fuertes
  ...
  2. **Etica Profesional**: Destaco tanto mis valores como mi compromiso etico que rige a un buen Profesional de la ciberseguridad e informatica, responsable, proactivo y siempre aprendiendo.
  3. **Vocacion**: Mi interes por la ciberseguridad nace de un hobbie de niño y que con el tiempo se transformo en lo que quiero hacer en el futuro que es proteger, mitigar y defender vulnerabilidades.

## Habilidades tecnicas 
* Fundamentos de Redes y Ciberseguridad
* Analisis de vulnerabilidades
* Configuracion de redes
* Virtualizacion y config
* Conocimiento de Estandares 
